...
实时追踪目标，开启实时追踪系统，让机械臂跟随摄像头画面中的移动目标。默认自动选择优先级最高的目标：start_tracking()
实时追踪指定类型目标，比如追踪人脸：start_tracking("face")，追踪红色盒子：start_tracking("red_box")，绿色盒子："green_box"，蓝色盒子："blue_box"，黄色盒子："yellow_box"
停止实时追踪：stop_tracking()
